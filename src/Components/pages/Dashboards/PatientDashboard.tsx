...
import { AvatarUpload } from '../../Dashboards/Patient/AvatarUpload'; // <--- Asegúrate de que esta ruta sea correcta
...
export const PatientDashboard = () => {
  ...
  // Función para refrescar la vista cuando se sube una foto
  ...
  if (loading) return (
    <div className="h-screen bg-brand-neutral flex flex-col items-center justify-center">
      ...
      <p className="font-serif italic text-brand-dark">Cargando santuario...</p>
    </div>
  );
    ...
    <div className="flex min-h-screen bg-brand-neutral bg-grain">
      ...
      <main className="flex-1 ml-72 p-12">
        <div className="max-w-6xl mx-auto space-y-12 animate-fade-in">
          ...
          {/* 1. HEADER DINÁMICO CON FOTO PROFESIONAL */}
          <header className="flex items-center gap-10 p-10 bg-white/40 rounded-[3.5rem] border border-brand-primary/10 backdrop-blur-sm shadow-inner shadow-brand-primary/5">
            ...
            <div className="space-y-3 flex-1">
              <h1 className="text-6xl font-serif text-brand-dark leading-none">
                Hola, {patient?.full_name?.split(' ')[0] || 'Omar'}
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white/80 backdrop-blur-md p-10 rounded-[3.5rem] border border-brand-primary/10 shadow-xl shadow-brand-primary/5">
                ...
                <div className="flex justify-between items-end">
                  ...
                  <button className="px-6 py-3 bg-brand-primary text-white text-[9px] font-bold uppercase tracking-widest rounded-full shadow-lg hover:scale-105 transition-all">
                    Agendar / Reprogramar
                  </button>
                </div>
              </div>
            ...
            {/* 4. PLAN DE TRATAMIENTO (Evolución) */}
          ...
          <div className="lg:col-span-3 space-y-8 pt-8">
